...
*/
function checkpoints_between_six_minutes($checkpoints, $route, $distance_matrix_url)
{
    $checkpoints_between_six_minutes = [];
    foreach ($checkpoints as $checkpoint) {
        $distance_matrix = get_distance_matrix($distance_matrix_url, [$checkpoint], $route, "test");
        if (is_between_six_minutes($distance_matrix)) {
